...
class Geometric(SIA):
    ...
    def aplicar_estrategia(self, condicion, alcance, mecanismo) -> Solution:
        ...
        self.seleccionar_biparticion_optima(presentes, futuros, estado_inicial, filas_tabla_costos)
    ...
    def seleccionar_biparticion_optima(self, presentes, futuros, estado_inicial, estados_vecinos):
        """
        ...
        for i, fila in enumerate(self.tabla_costos):
            ...
            if perdida < self.perdida:
                ...
                self.biparticion_prim = [
                    self.obtener_presentes_no_cambiados(estado_inicial, estados_vecinos[i], presentes),
                    futuros.tolist(),
                ]

    @staticmethod
    def obtener_presentes_no_cambiados(estado_inicial, estado_vecino_str, presentes) -> list:
        """
